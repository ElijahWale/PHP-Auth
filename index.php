...
<p>
   <?php 
   print_message(); print_error();
   ?>
</p>

   <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      <h1 class="display-4">Welcome to CVH: Corona Virus Hospital</h1>
      <p class="lead">This is a specialist hospital to cure Corona Virus Patients.</p>
